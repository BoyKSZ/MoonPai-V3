...
class Baizhu extends StatefulWidget {
  const Baizhu({Key? key}) : super(key: key);

  @override
  _BaizhuState createState() => _BaizhuState();
}

class _BaizhuState extends State<Baizhu> {
  ...
  List<String> imagePaths = [
    'images/character_profiles/BAIZHU/BAIZHU_PROFILE.png',
    'images/character_profiles/BAIZHU/BAIZHU_STORY.png',
    'images/character_profiles/BAIZHU/BAIZHU_TALENT.png'
  ];
