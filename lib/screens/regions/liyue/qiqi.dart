...
class Qiqi extends StatefulWidget {
  const Qiqi({Key? key}) : super(key: key);

  @override
  _QiqiState createState() => _QiqiState();
}

class _QiqiState extends State<Qiqi> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "21";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/QIQI/QIQI_PROFILE.png',
    'images/character_profiles/QIQI/QIQI_STORY.png',
    'images/character_profiles/QIQI/QIQI_TALENT.png'
  ];
