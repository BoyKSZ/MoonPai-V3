...
class Chongyun extends StatefulWidget {
  const Chongyun({Key? key}) : super(key: key);

  @override
  _ChongyunState createState() => _ChongyunState();
}

class _ChongyunState extends State<Chongyun> {
  ...
  List<String> imagePaths = [
    'images/character_profiles/CHONGYUN/CHONGYUN_PROFILE.png',
    'images/character_profiles/CHONGYUN/CHONGYUN_STORY.png',
    'images/character_profiles/CHONGYUN/CHONGYUN_TALENT.png'
  ];
