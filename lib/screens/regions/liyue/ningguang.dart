...
class Ningguang extends StatefulWidget {
  const Ningguang({Key? key}) : super(key: key);

  @override
  _NingguangState createState() => _NingguangState();
}

class _NingguangState extends State<Ningguang> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "20";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/NINGGUANG/NINGGUANG_PROFILE.png',
    'images/character_profiles/NINGGUANG/NINGGUANG_STORY.png',
    'images/character_profiles/NINGGUANG/NINGGUANG_TALENT.png'
  ];
