...
class Hutao extends StatefulWidget {
  const Hutao({Key? key}) : super(key: key);

  @override
  _HutaoState createState() => _HutaoState();
}

class _HutaoState extends State<Hutao> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "9";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/HUTAO/HUTAO_PROFILE.png',
    'images/character_profiles/HUTAO/HUTAO_STORY.png',
    'images/character_profiles/HUTAO/HUTAO_TALENT.png'
  ];
