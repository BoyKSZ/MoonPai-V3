...
class Zhongli extends StatefulWidget {
  const Zhongli({Key? key}) : super(key: key);

  @override
  _ZhongliState createState() => _ZhongliState();
}

class _ZhongliState extends State<Zhongli> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "29";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/ZHONGLI/ZHONGLI_PROFILE.png',
    'images/character_profiles/ZHONGLI/ZHONGLI_STORY.png',
    'images/character_profiles/ZHONGLI/ZHONGLI_TALENT.png'
  ];
