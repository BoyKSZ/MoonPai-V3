...
class Dehya extends StatefulWidget {
  const Dehya({Key? key}) : super(key: key);

  @override
  _DehyaState createState() => _DehyaState();
}

class _DehyaState extends State<Dehya> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "5";    // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/DEHYA/DEHYA_PROFILE.png',
    'images/character_profiles/DEHYA/DEHYA_STORY.png',
    'images/character_profiles/DEHYA/DEHYA_TALENT.png'
  ];
