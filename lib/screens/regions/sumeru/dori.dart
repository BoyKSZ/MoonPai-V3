...
class Dori extends StatefulWidget {
  const Dori({Key? key}) : super(key: key);

  @override
  _DoriState createState() => _DoriState();
}

class _DoriState extends State<Dori> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "6";    // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/DORI/DORI_PROFILE.png',
    'images/character_profiles/DORI/DORI_STORY.png',
    'images/character_profiles/DORI/DORI_TALENT.png'
  ];
