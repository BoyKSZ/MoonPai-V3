...
class Kaveh extends StatefulWidget {
  const Kaveh({Key? key}) : super(key: key);

  @override
  _KavehState createState() => _KavehState();
}

class _KavehState extends State<Kaveh> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "13";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/KAVEH/KAVEH_PROFILE.png',
    'images/character_profiles/KAVEH/KAVEH_STORY.png',
    'images/character_profiles/KAVEH/KAVEH_TALENT.png'
  ];
