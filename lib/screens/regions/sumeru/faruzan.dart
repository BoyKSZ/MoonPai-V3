...
class Faruzan extends StatefulWidget {
  const Faruzan({Key? key}) : super(key: key);

  @override
  _FaruzanState createState() => _FaruzanState();
}

class _FaruzanState extends State<Faruzan> {
  ...
  List<String> imagePaths = [
    'images/character_profiles/Faruzan/faruzanprofile.png',
    'images/character_profiles/Faruzan/faruzanstory.png',
    'images/character_profiles/Faruzan/faruzantalent.png'
  ];
