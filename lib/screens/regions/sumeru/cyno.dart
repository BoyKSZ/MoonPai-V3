...
class Cyno extends StatefulWidget {
  const Cyno({Key? key}) : super(key: key);

  @override
  _CynoState createState() => _CynoState();
}

class _CynoState extends State<Cyno> {
  ...
  List<String> imagePaths = [
    'images/character_profiles/CYNO/CYNO_PROFILE.png',
    'images/character_profiles/CYNO/CYNO_STORY.png',
    'images/character_profiles/CYNO/CYNO_TALENT.png'
  ];
