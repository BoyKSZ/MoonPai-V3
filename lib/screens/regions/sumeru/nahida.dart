...
class Nahida extends StatefulWidget {
  const Nahida({Key? key}) : super(key: key);

  @override
  _NahidaState createState() => _NahidaState();
}

class _NahidaState extends State<Nahida> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "18";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/NAHIDA/NAHIDA_PROFILE.png',
    'images/character_profiles/NAHIDA/NAHIDA_STORY.png',
    'images/character_profiles/NAHIDA/NAHIDA_TALENT.png'
  ];
