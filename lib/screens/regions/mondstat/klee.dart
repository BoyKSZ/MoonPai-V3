...
class Klee extends StatefulWidget {
  const Klee({Key? key}) : super(key: key);

  @override
  _KleeState createState() => _KleeState();
}

class _KleeState extends State<Klee> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "14";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/KLEE/KLEE_PROFILE.png',
    'images/character_profiles/KLEE/KLEE_STORY.png',
    'images/character_profiles/KLEE/KLEE_TALENT.png'
  ];
