...
class Venti extends StatefulWidget {
  const Venti({Key? key}) : super(key: key);

  @override
  _VentiState createState() => _VentiState();
}

class _VentiState extends State<Venti> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "25";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/VENTI/VENTI_PROFILE.png',
    'images/character_profiles/VENTI/VENTI_STORY.png',
    'images/character_profiles/VENTI/VENTI_TALENT.png'
  ];
