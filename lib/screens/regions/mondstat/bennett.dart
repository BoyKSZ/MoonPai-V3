...
class Bennett extends StatefulWidget {
  const Bennett({Key? key}) : super(key: key);

  @override
  _BennettState createState() => _BennettState();
}

class _BennettState extends State<Bennett> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "2";    // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/BENNETT/BENNETT_PROFILE.png',
    'images/character_profiles/BENNETT/BENNETT_STORY.png',
    'images/character_profiles/BENNETT/BENNETT_TALENT.png'
  ];
