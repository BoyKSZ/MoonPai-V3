...
class Jean extends StatefulWidget {
  ...
  @override
  _JeanState createState() => _JeanState();
}

class _JeanState extends State<Jean> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "10";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/JEAN/JEAN_PROFILE.png',
    'images/character_profiles/JEAN/JEAN_STORY.png',
    'images/character_profiles/JEAN/JEAN_TALENT.png'
  ];
