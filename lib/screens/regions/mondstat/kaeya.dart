...
class Kaeya extends StatefulWidget {
  const Kaeya({Key? key}) : super(key: key);

  @override
  _KaeyaState createState() => _KaeyaState();
}

class _KaeyaState extends State<Kaeya> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "12";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/KAEYA/KAEYA_PROFILE.png',
    'images/character_profiles/KAEYA/KAEYA_STORY.png',
    'images/character_profiles/KAEYA/KAEYA_TALENT.png'
  ];
