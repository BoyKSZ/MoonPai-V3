...
class Mona extends StatefulWidget {
  const Mona({Key? key}) : super(key: key);

  @override
  _MonaState createState() => _MonaState();
}

class _MonaState extends State<Mona> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "17";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/MONA/MONA_PROFILE.png',
    'images/character_profiles/MONA/MONA_STORY.png',
    'images/character_profiles/MONA/MONA_TALENT.png'
  ];
