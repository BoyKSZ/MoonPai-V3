...
class Lynette extends StatefulWidget {
  const Lynette({Key? key}) : super(key: key);

  @override
  _LynetteState createState() => _LynetteState();
}

class _LynetteState extends State<Lynette> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "15";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/LYNETTE/LYNETTE_PROFILE.png',
    'images/character_profiles/LYNETTE/LYNETTE_STORY.png',
    'images/character_profiles/LYNETTE/LYNETTE_TALENT.png'
  ];
