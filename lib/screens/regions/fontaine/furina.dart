...
class Furina extends StatefulWidget {
  const Furina({Key? key}) : super(key: key);

  @override
  _FurinaState createState() => _FurinaState();
}

class _FurinaState extends State<Furina> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "8";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/FURINA/FURINA_PROFILE.png',
    'images/character_profiles/FURINA/FURINA_STORY.png',
    'images/character_profiles/FURINA/FURINA_TALENT.png'
  ];
