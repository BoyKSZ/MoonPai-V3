...
class Wriothesley extends StatefulWidget {
  const Wriothesley({Key? key}) : super(key: key);

  @override
  _WriothesleyState createState() => _WriothesleyState();
}

class _WriothesleyState extends State<Wriothesley> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "26";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/WRIOTHESLEY/WRIOTHESLEY_PROFILE.png',
    'images/character_profiles/WRIOTHESLEY/WRIOTHESLEY_STORY.png',
    'images/character_profiles/WRIOTHESLEY/WRIOTHESLEY_TALENT.png'
  ];
