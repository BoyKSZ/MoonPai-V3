...
class Lyney extends StatefulWidget {
  const Lyney({Key? key}) : super(key: key);

  @override
  _LyneyState createState() => _LyneyState();
}

class _LyneyState extends State<Lyney> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "16";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/LYNEY/LYNEY_PROFILE.png',
    'images/character_profiles/LYNEY/LYNEY_STORY.png',
    'images/character_profiles/LYNEY/LYNEY_TALENT.png'
  ];
