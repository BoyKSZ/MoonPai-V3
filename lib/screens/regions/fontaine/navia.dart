...
class Navia extends StatefulWidget {
  const Navia({Key? key}) : super(key: key);

  @override
  _NaviaState createState() => _NaviaState();
}

class _NaviaState extends State<Navia> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "19";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/NAVIA/NAVIA_PROFILE.png',
    'images/character_profiles/NAVIA/NAVIA_STORY.png',
    'images/character_profiles/NAVIA/NAVIA_TALENT.png'
  ];
