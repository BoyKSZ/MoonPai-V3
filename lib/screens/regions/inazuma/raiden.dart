...
class Raiden extends StatefulWidget {
  const Raiden({Key? key}) : super(key: key);

  @override
  _RaidenState createState() => _RaidenState();
}

class _RaidenState extends State<Raiden> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "22";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/RAIDEN/RAIDEN_PROFILE.png',
    'images/character_profiles/RAIDEN/RAIDEN_STORY.png',
    'images/character_profiles/RAIDEN/RAIDEN_TALENT.png'
  ];
