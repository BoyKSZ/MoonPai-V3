...
class Sayu extends StatefulWidget {
  const Sayu({Key? key}) : super(key: key);

  @override
  _SayuState createState() => _SayuState();
}

class _SayuState extends State<Sayu> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "23";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/SAYU/SAYU_PROFILE.png',
    'images/character_profiles/SAYU/SAYU_STORY.png',
    'images/character_profiles/SAYU/SAYU_TALENT.png'
  ];
