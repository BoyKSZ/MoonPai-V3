...
class Yoimiya extends StatefulWidget {
  const Yoimiya({Key? key}) : super(key: key);

  @override
  _YoimiyaState createState() => _YoimiyaState();
}

class _YoimiyaState extends State<Yoimiya> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "28";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/YOIMIYA/YOIMIYA_PROFILE.png',
    'images/character_profiles/YOIMIYA/YOIMIYA_STORY.png',
    'images/character_profiles/YOIMIYA/YOIMIYA_TALENT.png'
  ];
