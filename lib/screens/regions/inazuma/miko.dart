...
class Miko extends StatefulWidget {
  const Miko({Key? key}) : super(key: key);

  @override
  _MikoState createState() => _MikoState();
}

class _MikoState extends State<Miko> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "27";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/MIKO/MIKO_PROFILE.png',
    'images/character_profiles/MIKO/MIKO_STORY.png',
    'images/character_profiles/MIKO/MIKO_TALENT.png'
  ];
