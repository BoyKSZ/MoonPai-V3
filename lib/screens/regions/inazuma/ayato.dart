...
class Ayato extends StatefulWidget {
  const Ayato({Key? key}) : super(key: key);

  @override
  _AyatoState createState() => _AyatoState();
}

class _AyatoState extends State<Ayato> {            // edit mo ung class name 
  Map<String, dynamic>? profileData;

  Future<void> getProfile() async {
    String charID = "11";   // ung character id, refer mo ung sa excel sheet
  ...
  List<String> imagePaths = [               // etong paths, kung pano sila nakapangalan sa drive (assets -> character profiles), all caps nmn lahat
    'images/character_profiles/AYATO/AYATO_PROFILE.png',
    'images/character_profiles/AYATO/AYATO_STORY.png',
    'images/character_profiles/AYATO/AYATO_TALENT.png'
  ];
                            ...
                            if(activePage == 0)
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      style: TextStyle(fontSize: 8.5, height: 1.82, fontFamily: 'Ayato-China'),
                                      children: <TextSpan>[
